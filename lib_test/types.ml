...
type material = {
  m_color     : Float3.t;
  m_diffuse   : float; (* Proportion of the light emitted by the actual light sources that is reflected by the surface *)
  m_specular  : float; (* Specular componenet *)
...
type hit = {
  t  : float; (* intersection distance on the ray *)
  u  : float; (* fst barycentric coord. *)
...
type ray = {
  origin  : Float3.t;
  normal  : Float3.t; (* unit length vector *)
  inormal : Float3.t; (* normal reciprocal *)  
}
